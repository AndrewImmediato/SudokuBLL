...
public class LatinSquare {
	...
	// instances variables added to LatinSquare.java
	...
	// methods added to LatinSquare.java
	...
	protected ArrayList<PuzzleViolation> getPV(){
		...
		private int[] RemoveZeros(int[] a) {
			while(ArrayUtils.contains(a, 0)) {
				a = ArrayUtils.removeElement(a, 0);
			}
...
//ArrayUtil - Need to update POM with Dependency to execute this
...
//adds a new for a row with dups
//for sudoku at end of HasDup
//return super.PV_Size() > 0;
//for 
